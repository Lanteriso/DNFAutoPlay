...
allskills = {
    ...
    '驱魔师': [
            Skill("a", 6, 1, 0.9,(250,120)),
            Skill("s", 12, 1, 0.9,(250,120)),
            Skill("d", 17, 1, 0.9,(250,120)),
            Skill("f", 34, 1, 0.9,(250,120)),
            Skill("g", 42, 1, 0.9,(250,120)),
            #Skill("h", 6, 1, 0.9,(250,120)),
            Skill("q", 11, 1, 0.9,(250,120)),
            Skill("w", 36, 1, 0.9,(250,120)),
    ...
    '合金': [
        ...
        Skill("q", 14, 1, 0.9, (450, 120)),
        Skill("w", 18, 1, 0.9, (450, 120)),
    ...
    '蓝拳': [
        ...
        Skill("d", 29, 1, 0.9, (450, 120)),
        Skill("f", 3, 1, 0.9, (450, 120)),
        Skill("g", 8, 1, 0.9, (450, 120)),
        Skill("h", 26, 1, 0.9, (450, 120)),
        Skill("q", 10, 1, 0.9, (450, 120)),
        Skill("w", 37, 1, 0.9, (450, 120)),
        Skill("e", 44, 1, 0.9, (450, 120)),
        Skill("r", 5, 1, 0.9, (450, 120)),
        Skill("t", 171, 1, 1, (450, 120)),
    ],
    '契魔者': [
        Skill("a", 7, 1, 0.9, (450, 120)),
    ...
    '黑暗武士': [
        ...
        Skill("t", 37, 1, 1, (450, 120)),
    ],
    '女光明骑士': [
        Skill("a", 13.8, 1, 0.9, (450, 120)),
        Skill("s", 20, 1, 0.9, (450, 120)),
        Skill("d", 20.7, 1, 0.9, (450, 120)),
        Skill("f", 9.4, 1, 0.9, (450, 120)),
        #Skill("g", 13.5, 1, 0.9, (450, 120)),
        #Skill("h", 18, 1, 0.9, (450, 120)),
        Skill("q", 31.4, 1, 0.9, (450, 120)),
        Skill("w", 19.5, 1, 0.9, (450, 120)),
        Skill("e", 24.3, 1, 0.9, (450, 120)),
        Skill("r", 2, 1, 0.9, (450, 120)),
