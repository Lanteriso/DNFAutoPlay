...
allskills = {
    ...
    '流浪武士': [
        Skill("a", 3.6, 1, 0.9, (450, 120)),
        Skill("s", 9.2, 1, 0.9, (450, 120)),
        Skill("d", 23, 1, 0.9, (450, 120)),
        Skill("f", 8.6, 1, 0.9, (450, 120)),
        Skill("g", 38.5, 1, 0.9, (450, 120)),
        Skill("h", 46.2, 1, 0.9, (450, 120)),
        Skill("q", 16, 1, 0.9, (450, 120)),
        Skill("w", 29.5, 1, 0.9, (450, 120)),
        Skill("e", 30.8, 1, 0.9, (450, 120)),
        Skill("r", 32.4, 1, 0.9, (450, 120)),
        Skill("t", 124, 1, 1, (450, 120)),
    ],
    '驭剑士': [
    ...
    '黑夜术士': [
        Skill("a", 5.6, 1, 0.9, (450, 120)),
        Skill("s", 16, 1, 0.9, (450, 120)),
        Skill("d", 21, 1, 0.9, (450, 120)),
        Skill("f", 23, 1, 0.9, (450, 120)),
        Skill("g", 37, 1, 0.9, (450, 120)),
        #Skill("h", 25, 1, 0.9, (450, 120)),
        Skill("q", 37, 1, 0.9, (450, 120)),
        Skill("w", 38, 1, 0.9, (450, 120)),
        Skill("e", 41, 1, 0.9, (450, 120)),
        Skill("r", 49, 1, 0.9, (450, 120)),
        Skill("t", 189, 1, 1, (450, 120)),
    ],
}
